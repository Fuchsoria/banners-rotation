...
func RegisterBannersRotationHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BannersRotationServer) error {
	...
	mux.Handle("POST", pattern_BannersRotation_AddBanner_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/event.BannersRotation/AddBanner", runtime.WithHTTPPathPattern("/banners/add"))
		if err != nil {
...
func RegisterBannersRotationHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BannersRotationClient) error {
	...
	mux.Handle("POST", pattern_BannersRotation_AddBanner_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/event.BannersRotation/AddBanner", runtime.WithHTTPPathPattern("/banners/add"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_BannersRotation_AddBanner_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"banners", "add"}, ""))
)
